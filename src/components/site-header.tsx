...
export async function SiteHeader() {
  ...
  return (
    <header className="border-b border-black/10 bg-white">
      <div className="mock-header-inner mx-auto grid min-h-32 max-w-[1380px] grid-cols-[1fr_auto] items-center gap-5 px-5 py-5 sm:px-8 lg:grid-cols-[220px_1fr_220px] lg:px-10">
